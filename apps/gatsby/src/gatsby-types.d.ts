...
type Frontmatter_publishedAtArgs = {
  difference: InputMaybe<Scalars['String']>;
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  locale: InputMaybe<Scalars['String']>;
...
type MarkdownRemarkFrontmatterMeta = {
  readonly _edit_last: Maybe<Scalars['String']>;
  readonly _utw_tags_0: Maybe<Scalars['String']>;
  readonly dsq_thread_id: Maybe<Scalars['String']>;
  readonly sociableoff: Maybe<Scalars['String']>;
};

type MarkdownRemarkFrontmatterMetaFieldSelector = {
  readonly _edit_last: InputMaybe<FieldSelectorEnum>;
  readonly _utw_tags_0: InputMaybe<FieldSelectorEnum>;
  readonly dsq_thread_id: InputMaybe<FieldSelectorEnum>;
  readonly sociableoff: InputMaybe<FieldSelectorEnum>;
};

type MarkdownRemarkFrontmatterMetaFilterInput = {
  readonly _edit_last: InputMaybe<StringQueryOperatorInput>;
  readonly _utw_tags_0: InputMaybe<StringQueryOperatorInput>;
  readonly dsq_thread_id: InputMaybe<StringQueryOperatorInput>;
  readonly sociableoff: InputMaybe<StringQueryOperatorInput>;
};

type MarkdownRemarkFrontmatterMetaSortInput = {
  readonly _edit_last: InputMaybe<SortOrderEnum>;
  readonly _utw_tags_0: InputMaybe<SortOrderEnum>;
  readonly dsq_thread_id: InputMaybe<SortOrderEnum>;
  readonly sociableoff: InputMaybe<SortOrderEnum>;
};
...
type MarkdownArticlesForIndexQueryVariables = Exact<{ [key: string]: never; }>;


type MarkdownArticlesForIndexQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null } | null, readonly fields: { readonly slug: string | null } | null }> } };

type MarkdownArticlesForFeedQueryVariables = Exact<{ [key: string]: never; }>;


type MarkdownArticlesForFeedQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null }> } };
