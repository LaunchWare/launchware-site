        ...
        <ul className="our-beliefs__grid">
          <li>
            ...
            <p className="our-beliefs__text">
              We're adamant that technology should enhance the well-being of its users. If a
              project's intent is deceptive or ethically questionable, it doesn't just merit
              reconsideration—it simply won't be built by us.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p className="our-beliefs__text">
              ...
              crucial. It enables us to understand not just what needs to be built, but why, for
          ...
          <li>
            <p className="our-beliefs__text">
              ...
              profitable, but also meaningful and enduring. If these beliefs resonate with you,
              you're likely the kind of partner we're looking to collaborate with.
            </p>
          </li>
        </ul>
      </div>
