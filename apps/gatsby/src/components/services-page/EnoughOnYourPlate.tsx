...
export function EnoughOnYourPlate() {
  return (
      ...
      <div className="enough-on-your-plate__contents">
        ...
        <div className="enough-on-your-plate__text-container">
          ...
          <p className="enough-on-your-plate__text">
            Micromanaging your development partner shouldn’t be another item on your to-do list.
            We’re in the business of launching.
          </p>
