  ...
  return (
    <section className="leaders">
      ...
      <div className="leaders__contents">
        ...
        <div className="leaders__grid">
          <div className="leaders__card">
            ...
            <div className="leaders__text-container">
              ...
              <p className="leaders__text">
                Dan believes software has the profound power to better our lives. Yet, as a respected
                technology leader and seasoned software developer, Dan often noticed a recurring
                issue: product teams trapped in a web of miscommunication, failing to sharply define
                the problems they intended to solve. The aftermath? Solutions riddled with technical
                debt, an inability to adapt to changing user needs, and oversights that let users
                down.
              </p>
              <p className="leaders__text">
              ...
              <p className="leaders__text">
                However, Dan isn’t just an empathetic ear. He's a solutions architect. Equipped with a
                Computer Science degree from Worcester Polytechnic Institute, his resume includes a
                role as a Director of Engineering and 15 rich years of consulting. He’s also a teacher
                at heart, having helped train over 1000 Software Engineers via Launch Academy.
                Partnering with Dan means you aren't merely crafting software; you're making dreams
          ...
          <div className="leaders__card">
            ...
            <div className="leaders__text-container">
              ...
              <p className="leaders__text">
                Bill's empathy stems from a simple yet profound belief: Every participant in a project
                is an individual human being. We all have our personal and professional hurdles, and
                we all make mistakes. By keeping the people, both developers and end-users, at the
                forefront, he champions the creation of long-term, effective solutions.
              </p>
              <p className="leaders__text">
                With over 20 years as a Software Engineer, Bill brings a wealth of experience to the
                table. He has thrived in various team sizes and has also managed departments of 30 or
                more, enabling him to address a spectrum of challenges. He’s an authority on both the
                technical and business nuances of software development.
              </p>
              <p className="leaders__text">
                A graduate of WPI in Computer Science, Bill blends his professional pursuits with an
                enriching personal life in Massachusetts. A loving husband and father of two, he's an
                avid mountain biker and skier, making the most of New England's diverse seasons. His
                family time is cherished, whether they're on the road or engaging in domestic
                projects.
              </p>
              <p className="leaders__text">
                One commendation from a previous manager succinctly captures Bill's unique value: “He
                thinks more strategically about our business, offering a refreshing perspective amid
                operation-focused managers.” For Bill, the business impact of his role is just as
        ...
        <button
          className="leaders__button button"
          type="button"
